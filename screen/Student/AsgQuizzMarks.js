...
const AsgQuizzMarks = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.conatiner}>
            ...
            <View style={{ marginTop: 2, flexDirection: 'row', paddingHorizontal: 36, paddingVertical: 10, backgroundColor: '#77dd77', marginHorizontal: 15, borderRadius: 10, opacity: 0.7, elevation: 4, marginTop: 10 }}>
                <View style={{ flex: 9, marginLeft: 5, marginRight: 5, }}>
                    <Text style={{ fontSize: 12, color: 'black' }}>Title</Text>
                </View>
                <View style={{ flex: 6, marginLeft: 1, marginRight: 50 }}>
                    <Text style={{ fontSize: 12, color: 'black' }}>Total Marks</Text>
                </View>
                <View style={{ flex: 5, marginLeft: 5, marginRight: 5 }}>
                    <Text style={{ fontSize: 12, color: 'black' }}>Obtained Marks</Text>
                </View>
